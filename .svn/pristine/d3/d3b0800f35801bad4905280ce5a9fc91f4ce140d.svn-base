...
import com.dfire.retail.app.manage.activity.stockmanager.AdjustmentReasonActivity;
...
public class AdjustmentReasonAdapter extends BaseAdapter{
	...
	public AdjustmentReasonAdapter(Context mContext,List<Map> datas,String typeVal) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (data!=null) {
			...
			if(!StringUtils.isEmpty(typeVal) && StringUtils.isEquals(data.get("typeVal"), typeVal)){
				...
				((AdjustmentReasonActivity)mContext).getView(lHolderView.getTypeiv());
			}else{
