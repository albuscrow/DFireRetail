...
/**
 * 物流管理-门店进货-门店进货详细信息适配器
 * @author wangpeng
 *
 */
public class StoreCollectDetailAdapter extends BaseAdapter{

	private Context context;
	private List<StockInDetailVo> list=new ArrayList<StockInDetailVo>();
	private LayoutInflater mLayoutInflater;
	
	public StoreCollectDetailAdapter(Context context, List<StockInDetailVo> list) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
	        ...
	        viewHolder.nowStore.setText(list.get(position).getGoodsSum());
