...
public class PullToRefreshStickyListView extends PullToRefreshAdapterViewBase<StickyListHeadersListView> {
	...
	public PullToRefreshStickyListView(Context context, Mode mode, AnimationStyle style) {
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX, int scrollRangeY, int maxOverScrollX, int maxOverScrollY, boolean isTouchEvent) {
			...
			OverscrollHelper.overScrollBy(PullToRefreshStickyListView.this, deltaX, scrollX, deltaY, scrollY, isTouchEvent);
