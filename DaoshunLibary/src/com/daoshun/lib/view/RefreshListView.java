...
public class RefreshListView extends ListView implements OnScrollListener {
    ...
    public void setHeaderViewMode(boolean model) {
        if (model) {
            if (mRefreshHeaderViewText != null && mRefreshHeaderViewLastRefresh != null) {
                mRefreshHeaderViewText.setTextColor(Color.WHITE);
                mRefreshHeaderViewLastRefresh.setTextColor(Color.WHITE);
            }
        } else {
            if (mRefreshHeaderViewText != null && mRefreshHeaderViewLastRefresh != null) {
                mRefreshHeaderViewText.setTextColor(Color.parseColor("#4c5b83"));
                mRefreshHeaderViewLastRefresh.setTextColor(Color.parseColor("#4c5b83"));
            }
        }
    }
