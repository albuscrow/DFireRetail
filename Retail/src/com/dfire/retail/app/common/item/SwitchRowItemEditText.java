...
public class SwitchRowItemEditText extends ItemBase {
	 ...
	 * @param attrs
	 */
	public SwitchRowItemEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		inflater.inflate(R.layout.globe_item_edit_text_row, this);
		initMainView();
	 ...
	 */
	public void initLabel(String label, final String hit, Boolean isRequest,
			int inputType) {
		...
		lblVal.setHint(isRequest ? hit : "可不填");
		...
		lblVal.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				...
				if(CommonUtils.isEmpty(val)){
					lblVal.setHint(SwitchRowItemEditText.this.isRequest ? hit : "可不填");	
					img.setVisibility(View.GONE);
				}
				isChangeEditText();
				if(itemChange!=null){
					itemChange.onItemEditTextChange(SwitchRowItemEditText.this);
				}
