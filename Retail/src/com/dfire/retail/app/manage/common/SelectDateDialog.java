...
import com.dfire.retail.app.manage.wheel.widget.OnWheelClickedListener;
...
public class SelectDateDialog extends Dialog{
	...
	public SelectDateDialog(Context context, String type) {
		super(context, R.style.dialog);
		mContext = context;
		mType = type;
	}
	
	public SelectDateDialog(Context context,boolean isClear){
		super(context,R.style.dialog);
		mContext = context;
...
//		params.width =width/5*4;
		...
		// year
		mYearAdapter = new YearNumericAdapter(mContext, 1960, 2035, 1990);
		mYear.setViewAdapter(mYearAdapter);
		mYear.setCurrentItem(curYear - 1960);
		mYear.addClickingListener(new OnWheelClickedListener() {
	...
	void updateDays(WheelView year, WheelView month, WheelView day) {
		...
		calendar.set(Calendar.YEAR, 1960 + year.getCurrentItem());
