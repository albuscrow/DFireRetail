...
public class PerformanceDetailActivity extends TitleActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new LogBookDetailAdapter(PerformanceDetailActivity.this, mList);
		mListView.setAdapter(adapter);
		
		adapter2 = new LogBookDetailAdapter(PerformanceDetailActivity.this, mPayDetailList);
	...
	private void initDetailList(){
		...
		mList.add(new CommonItem("业绩提成(元)","", "500.00"));
