...
//	}
	 ...
	 * @return 如果省份和城市ID都正确，返回城市名称,否则返回""
	 */
	public Integer getCityID(Integer provId,String cityName,List<ProvinceVo> mAdressList){
...
public String getDistrictName(Integer provId,Integer cityId,Integer countyId,List<ProvinceVo> mAdressList){
	...
	public Integer getDistrictID(Integer provId,Integer cityId,String name,List<ProvinceVo> mAdressList){
...
//			getProgressDialog().dismiss();
			...
			switch (msg.what) {
				...
				case Constants.HANDLER_ERROR:
				    ...
				    if(msg.arg1 ==1) ShopInfoBaseActivity.this.finish();
...
//		params.setParam(Constants.SHOP,mShopVo.toString());
		...
		AsyncHttpPost httpsave = new AsyncHttpPost(ShopInfoBaseActivity.this,params,ShopSaveBo.class,true,
	    new RequestCallback() {
	        @Override
...
public void deleteShopInfo( String deleteShopID){
	    	...
	    	AsyncHttpPost	httppost = new AsyncHttpPost(ShopInfoBaseActivity.this,param,BaseRemoteBo.class,true,
	        new RequestCallback() {
	            @Override
	            public void onSuccess(Object str) {
