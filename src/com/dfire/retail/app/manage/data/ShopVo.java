...
public class ShopVo implements Serializable {
    ...
    public ShopVo(JSONObject jobj) throws JSONException {
        if (jobj != null) {
            ...
            provinceId = jobj.getString("provinceId");
            cityId = jobj.getString("cityId");
            countyId = jobj.getString("countyId");
            streetId = jobj.getString("streetId");
    ...
    public void initData(JSONObject jobj) throws JSONException {
        ...
        if (!jobj.isNull("shopList")) {
            ...
            for (int i = 0; i < obj.length(); i++) {
                shopList.add(new ShopVo(obj.getJSONObject(i)));
            }
        }
        ...
        if (!jobj.isNull("fileSuffix")) {
            fileSuffix = jobj.getString("fileSuffix");
        }
    }
