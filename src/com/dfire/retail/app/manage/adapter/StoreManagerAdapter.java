...
public class StoreManagerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.storemanager_item,
                    null);
            viewHolder = new ViewHolder();
            viewHolder.imageView = (ImageView) convertView
                    .findViewById(R.id.storemanagericon);
            viewHolder.mainText = (TextView) convertView
                    .findViewById(R.id.storemanager_item_main_title);
            viewHolder.subheadText = (TextView) convertView
                    .findViewById(R.id.storemanager_item_subhead_title);
