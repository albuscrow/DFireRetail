...
public class SelectShopAdapter extends BaseAdapter{
	...
	public SelectShopAdapter(Context mContext,List<AllShopVo> allShopVos,String selectShopId) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (allShopVo!=null) {
			...
			if (allShopVo.getCode().equals("")) {
				...
				lHolderView.getShop_code().setVisibility(View.GONE);
			}else {
				lHolderView.getShop_code().setText("店家代码: "+allShopVo.getCode());
			}
			lHolderView.getShop_code().setTextColor(Color.parseColor("#174C83"));
			if (selectShopId.equals(allShopVo.getShopId())) {
