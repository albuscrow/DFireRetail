...
public class MessageDetailActivity extends TitleActivity implements OnClickListener {
				...
				if (isInit) {
					...
					new AsyncHttpPost(params, new RequestResultCallback() {
						...
						public void onFail(Exception e) {
							ToastUtil.showShortToast(MessageDetailActivity.this,
									Constants.getErrorInf(null, null));
							e.printStackTrace();
						}
					}).execute();
			...
			private class ShopListAdapter extends BaseAdapter {
				...
				public View getView(int position, View convertView, ViewGroup parent) {
					LayoutInflater inflater = LayoutInflater
							.from(MessageDetailActivity.this);
			...
			private void openDate() {
				mDateDialog = new DateDialog(MessageDetailActivity.this);
				mDateDialog.show();
