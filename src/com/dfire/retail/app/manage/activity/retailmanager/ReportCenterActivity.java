...
//                "已添加2个职位，5个员工", EmployeeInfoActivity.class));
        ...
        mList.add(new StoreManagerItem(R.drawable.yuanong, "员工业绩查询", "查询员工详细业绩",
                EmployeeInfoActivity.class));
        mList.add(new StoreManagerItem(R.drawable.yuanong, "商品销售明细表", "查询商品销售明细",
                EmployeeInfoActivity.class));
        mList.add(new StoreManagerItem(R.drawable.yuanong, "销售日报表", "销售日报表",
                EmployeeInfoActivity.class));
        mList.add(new StoreManagerItem(R.drawable.yuanong, "销售月报表", "销售月报表",
                EmployeeInfoActivity.class));
        mList.add(new StoreManagerItem(R.drawable.yuanong, "会员交易查询", "查询会员交易信息",
                EmployeeInfoActivity.class));
        //
